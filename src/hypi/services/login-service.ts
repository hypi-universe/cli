...
export default class LoginService {
  ...
  async promptLoginByDomain() {
    ...
    let loginWithDomainResponse: any = await inquirer.prompt([
      {
        name: 'domain',
  ...
  async promptLoginByEmail() {
    ...
    let loginWithEmailResponse: any = await inquirer.prompt([
      {
        name: 'email',
  ...
  async login() {
    ...
    } else if (this.LoginMethod == Loginmethods.ByDomainAndToken) {
