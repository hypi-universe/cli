...
@hypi/cli/0.5.1 linux-x64 node-v14.17.5
$ hypi --help [COMMAND]
USAGE
  $ hypi COMMAND
...
...
_See code: [src/commands/config.ts](https://github.com/hypi-universe/cli/blob/v0.5.1/src/commands/config.ts)_
...
_See code: [src/commands/generate.ts](https://github.com/hypi-universe/cli/blob/v0.5.1/src/commands/generate.ts)_
...
_See code: [src/commands/init.ts](https://github.com/hypi-universe/cli/blob/v0.5.1/src/commands/init.ts)_
...
_See code: [src/commands/login.ts](https://github.com/hypi-universe/cli/blob/v0.5.1/src/commands/login.ts)_
...
_See code: [src/commands/sync.ts](https://github.com/hypi-universe/cli/blob/v0.5.1/src/commands/sync.ts)_
...
_See code: [src/commands/wsk.ts](https://github.com/hypi-universe/cli/blob/v0.5.1/src/commands/wsk.ts)_
<!-- commandsstop -->
