...
@hypi/cli/0.3.0 linux-x64 node-v14.17.1
$ hypi --help [COMMAND]
USAGE
  $ hypi COMMAND
...
...
_See code: [src/commands/config.ts](https://github.com/hypi-universe/cli/blob/v0.3.0/src/commands/config.ts)_
...
_See code: [src/commands/generate.ts](https://github.com/hypi-universe/cli/blob/v0.3.0/src/commands/generate.ts)_
...
_See code: [src/commands/init.ts](https://github.com/hypi-universe/cli/blob/v0.3.0/src/commands/init.ts)_
...
_See code: [src/commands/login.ts](https://github.com/hypi-universe/cli/blob/v0.3.0/src/commands/login.ts)_
...
_See code: [src/commands/sync.ts](https://github.com/hypi-universe/cli/blob/v0.3.0/src/commands/sync.ts)_
